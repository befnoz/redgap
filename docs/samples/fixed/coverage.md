...
| 12 | T1518 | Software Discovery | Discovery | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000001 |
...
| 16 | T1497.001 | Virtualization/Sandbox Evasion: System Checks | Defense Evasion / Discovery | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000002 |
...
| 24 | T1098.004 | Account Manipulation: SSH Authorized Keys | Persistence / Privilege Escalation | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000003 |
| 25 | T1552.001 | Unsecured Credentials: Credentials In Files | Credential Access | yes | - | fa4aaed5-4fe0-498d-bbc0-08e3346387ba |
| 26 | T1003.008 | OS Credential Dumping: /etc/passwd and /etc/shadow | Credential Access | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000004 |
| 27 | T1552.004 | Unsecured Credentials: Private Keys | Credential Access | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000005 |
| 28 | T1560.001 | Archive Collected Data: Archive via Utility | Collection | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000006 |
...
| 47 | T1201 | Password Policy Discovery | Discovery | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000007 |
| 48 | T1614.001 | System Location Discovery: System Language Discovery | Discovery | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000008 |
| 49 | T1613 | Container and Resource Discovery | Discovery | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000009 |
| 50 | T1070.003 | Indicator Removal: Clear Command History | Defense Evasion | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000010 |
| 51 | T1543.002 | Create or Modify System Process: Systemd Service | Persistence / Privilege Escalation | yes | - | 7c1a9e10-1a2b-4c3d-8e4f-000000000011 |
...
- **T1087.001** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000087` on event `ev_8cc32953659d6a0f`: `CommandLine`='cat /etc/passwd', `Image`='/usr/bin/cat'
- **T1136.001** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000136` on event `ev_00ee036183e7da02`: `Image`='/usr/sbin/useradd'
...
- **T1070.006** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000706` on event `ev_5634ee49b5c0ce99`: `CommandLine`='touch -r /etc/hostname /tmp/redgap_agent_file', `Image`='/usr/bin/touch'
...
- **T1518** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000001` on event `ev_1a81eeb0340cdace`: `CommandLine`='dpkg -l', `Image`='/usr/bin/dpkg'
...
- **T1497.001** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000002` on event `ev_1e3b3ebf9cc18d77`: `CommandLine`='cat /sys/class/dmi/id/product_name', `Image`='/usr/bin/cat'
...
- **T1098.004** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000003` on event `ev_43c9f9741c4786a5`: `CommandLine`='tee -a /root/.ssh/authorized_keys', `Image`='/usr/bin/tee'
...
- **T1003.008** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000004` on event `ev_0c48d238224ad068`: `CommandLine`='getent shadow', `Image`='/usr/bin/getent'
- **T1552.004** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000005` on event `ev_f8b857c46a1423c2`: `CommandLine`='cat /root/.ssh/id_rsa', `Image`='/usr/bin/cat'
- **T1560.001** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000006` on event `ev_0be670fc64c68b4d`: `CommandLine`='tar -czf /tmp/rg_loot.tgz /etc/hostname /etc/os-release', `Image`='/usr/bin/tar'
...
- **T1201** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000007` on event `ev_49e4b0b9335d51b4`: `CommandLine`='chage -l root', `Image`='/usr/bin/chage'
- **T1614.001** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000008` on event `ev_21493b7467eea957`: `Image`='/usr/bin/locale'
- **T1613** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000009` on event `ev_9cce5f0b82b60a5e`: `CommandLine`='cat /proc/1/cgroup', `Image`='/usr/bin/cat'
- **T1070.003** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000010` on event `ev_485df99f9f8c40af`: `CommandLine`='truncate -s 0 /root/.bash_history', `Image`='/usr/bin/truncate'
- **T1543.002** - rule `7c1a9e10-1a2b-4c3d-8e4f-000000000011` on event `ev_c397d9ee0eac1b0a`: `CommandLine`='cp /etc/hostname /etc/systemd/system/redgap-test.service', `Image`='/usr/bin/cp'

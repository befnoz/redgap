...
- **T1070.006** — rule `7c1a9e10-1a2b-4c3d-8e4f-000000000706` on event `ev_5f0ee45189e9b6a6`: `CommandLine`='touch -r /etc/hostname /tmp/redgap_agent_file', `Image`='/usr/bin/touch'
